...
The contract for the board line of that name, settled with the user on 2026-09-10 and shipped as
`a6bc00b` the same day. It works around a Phaser 4.2.1 renderer defect the user reported upstream
as [phaserjs/phaser#7372](https://github.com/phaserjs/phaser/issues/7372). No design page is
involved. The file outlives its line because *The rules line wraps through Phaser* rests on the
finding below; it goes with that line.
