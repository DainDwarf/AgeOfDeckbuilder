...
- `docs/INTERFACE.md`, _The presses_, the paragraph on a thing named in a card's text, after "a card as its face, anything else as the card the infopanel reads it by": "a card named is shown as its content makes it, at the counters it starts with".
