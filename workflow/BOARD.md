...
- **Player-facing text polish** — going over every player-facing text for polish, more importantly every card; cards stay short, and every noun the player cannot yet look up — an improvement, a feature, a card another card names — is listed for the reference lines.
