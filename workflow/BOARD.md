...
- **A staleness pass over the tests** — fixtures carrying pieces that no longer act, like the worker at `LURE` left after the fixture's own script took over from the default one.
