...
const TEXT = {
  ...
  'card.gather': 'Gather',
  'rules.gather': 'Through a worker outside the border: gain the yield of its tile',
  ...
  'answer-rules.let-them-go': 'One population leaves the city, idle first',
  'answer.keep-them': 'Keep them',
  'answer-rules.keep-them': 'They stay',
  'event.herd': 'The herd',
  'answer.hunt-it': 'Hunt it',
  'answer-rules.hunt-it': 'Gain {food} [food]',
  'answer.follow-it': 'Follow it',
  'answer-rules.follow-it': 'Deals game onto a forest tile near the city and charts it',
  ...
  'refusal.slot-filled': 'A building already stands there.',
  'refusal.other-faction': 'That tile belongs to another faction.',
  'refusal.improvement-laid': 'That improvement is already there.',
  'refusal.no-unit': 'No unit stands there.',
  'refusal.unit-standing': 'A unit already stands there.',
