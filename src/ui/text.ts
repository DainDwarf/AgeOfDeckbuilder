...
const TEXT = {
  ...
  'card.PH_FirstWarrior': 'PH_FirstWarrior',
  ...
  'rules.PH_FirstWarrior': 'Place a [player:PH_Warrior]',
  ...
  'answer.PH_Freeze': 'PH_Freeze',
  'answer-rules.PH_Freeze': 'Lays {cards} [card:PH_Frost] on top of the draw pile',
