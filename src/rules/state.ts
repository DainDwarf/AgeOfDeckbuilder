 ...
 * building slot filled, the tile another faction's, the improvement already laid, no unit of the player's standing there, a
 * unit already standing there, its move points full, the tile no claim of the city's.
 */
