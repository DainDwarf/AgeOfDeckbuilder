...
- **The capstone's two groups named apart** — the capstone's landing and its second script share the group name `capstone`, so the victory read tells them apart by turn; they get names of their own, the right shape for the long term.
