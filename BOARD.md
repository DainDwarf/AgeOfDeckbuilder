...
- **The city's entry holds its content** — the city's sight, the tiles the settle holds and the idle inhabitants it opens with become content on the catalogue's city entry, no longer constants in the rules.
