...
was a fixed objective became a city on a map whose pressure is the age it lives through.
...
- You found **one city** on a generated **hexagonal map** of varied terrain. Over the run you extend
  ...
  and deal with neutral peoples on the map.
- The run spans **one age**, from its dawn to the threshold of the next. Its history is an
  **escalating schedule of events** — enemies, natural disasters, inner turmoil, plus neutral and
  ...
  next age is victory; the city's collapse ends its story. A run spanning every age was rejected:
...
- The five core resources of *Prelude* return with much the same flavour: **food, production,
  military, money, science**. **Culture pushes the border out**; territory is the tiles held;
  population is the workers on tiles and in buildings.
...
- **Site** — a bias on map generation: temperate, desert, coast, mountains, polar, … The site is
  the **difficulty dial**, and honestly so: a harsh site pays more influence, and some achievements
  are reachable only from a site that has what they need — *Sailing* wants a coast. 🔧 A freely
  chosen site with no such stakes was rejected: every launch would take the easiest.
- **People** — who you are: starting units, one passive rule, a look. A people owns its deck —
  one deck per people, edited as a facet of that people. 🔧
