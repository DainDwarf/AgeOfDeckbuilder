...
| Term | Meaning | Not |
|------|---------|-----|
| **age** | One span of history: the unit a run plays through, the campaign unlocks, and content is partitioned by. | era, epoch, period, tier |
...
| **achievement** | A goal a run can reach; reaching it unlocks a technology. | mission, objective, quest, milestone |
| **influence** | The meta-currency every run pays, scaled by how the city fared. | gold, points, XP |
| **city** | The player's single settlement; what a run is about. | town, capital, base, settlement |
| **map** | The hexagonal grid a run is played on. | board, world, grid |
...
| **event** | One entry of the age's schedule; what the run throws at the city. | disaster, threat, crisis, encounter |
| **capstone** | The age's final trial; passing it is victory. | boss, finale, objective |
| **victory** | The end of a run by passing the capstone. | win, success, triumph |
| **defeat** | The end of a run by the city's fall. | collapse, game over, loss, death |
