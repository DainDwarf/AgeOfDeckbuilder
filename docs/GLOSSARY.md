...
| **civilization** | A playable identity: starting units, one passive rule, a look, and its deck. | people, faction, nation, civ |
...
| **map** | The hexagonal grid a chronicle is played on. | world, grid |
