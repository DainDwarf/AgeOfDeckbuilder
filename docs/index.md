...
- [`DESIGN.md`](DESIGN.md) — the game in broad strokes: the pitch, launching a chronicle, the meta, scope. Names the other four design pages; the five are the spec, every section marked decided or provisional, its rationale inline.
...
- [`CHRONICLE.md`](CHRONICLE.md) — the rules a chronicle is played by: the turn, sight, the city, units, cards, events.
