...
- [`DESIGN.md`](DESIGN.md) — the game in broad strokes: the pitch, the chronicle, launching a chronicle, the meta, scope. Names the other four design pages; the five are the spec, every section marked decided or provisional, its rationale inline.
