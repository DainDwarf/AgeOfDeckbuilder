...
- **Events carry lore** (v0.0.6, the look): an event's window explains the situation in text — what is happening to the city, and why its answers are the ways out — and the deal window is reworked around that text; until then the title is the event's bare name over the answers' cards.
