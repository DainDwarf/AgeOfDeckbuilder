...
| `npm run e2e` | The whole Playwright/Chromium suite, starting the dev server itself; this is the CI check on push to main. Locally, run one spec: `npx playwright test e2e/<spec>.spec.ts`. |
