...
// Discovered work is handed to the user for /todo (a board line or an ideas jot) or gets done now.
    ...
    JSON.stringify({
      hookSpecificOutput: {
        ...
        permissionDecisionReason:
          ...
          'do it now, or hand it to the user for /todo (a board line or an ideas jot) and ' +
